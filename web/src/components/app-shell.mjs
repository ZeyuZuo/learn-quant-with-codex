...
export function AppShell({ data, currentLocale, languages, children, title, description, pageClass = "" }) {
  const pageTitle = title || data.home.title;
  const pageDescription = description || data.home.description;
...
<html lang="${currentLocale}">
  <head>
    ...
    <title>${escapeHtml(pageTitle)} | ${escapeHtml(data.site.projectName)}</title>
