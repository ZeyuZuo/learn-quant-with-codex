# learn-quant-with-codex 课程设计 v3
...
初学者最容易卡住的不是某个复杂公式，而是不知道一段量化代码到底在解决哪一类问题。v3 采用以下认知阶梯：
...
v3 课程分为 10 个模块、47 节课、9 个 Mini Project 和 1 个 Capstone。
