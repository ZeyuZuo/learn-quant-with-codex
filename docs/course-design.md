...
v2 课程分为 10 个模块、36 节课、8 个 Mini Project 和 1 个 Capstone。
...
| 4 | 信号、仓位和成本 | 策略想法如何变成可回测的持仓？ | signal/position/cost 模块 |
...
完成 36 节课、8 个 Mini Project 和 Capstone。
