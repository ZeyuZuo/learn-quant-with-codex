...
本课程参考了几类成熟教程的编排方式，但不照搬它们的内容。v4.4 的重点是把参考教程里的教学机制转成本站的课程设计硬约束：每节课必须有明确问题、代码产物、图表观察、练习反馈、Codex 任务和可验收 Checkpoint；每个模块必须有一个能进入 Capstone 的交付物。
...
| --- | --- | --- |
| QuantConnect 的 task / result / hint | 先尝试 Quiz 或小练习，再复制 Codex Task，最后按命令验收 | Prompt 有验收命令，Checkpoint 写明成功标准 |
...
| 模块 | 进入闸门 | 退出闸门 |
| --- | --- | --- |
| Module 0 | 能运行项目基本命令 | 写下非投资建议边界，完成第一条带验收的 Codex Prompt |
