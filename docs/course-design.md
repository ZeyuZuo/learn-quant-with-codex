...
v4.3 已经确定 10 模块、47 节课、9 个 Mini Project 和 1 个 Capstone，并把参考教程机制写进课程设计。v4.4 不新增课程数量，而是解决课程真正写作和学习体验中最容易失控的六个问题：
...
| Zipline 的执行现实 | 策略前先区分 signal、position、lag、cost 和执行简化 | Module 4 必须早于 Module 5 和 Module 6 完成 |
...
47 节课不应该全部写成同一种文章。v4.4 将课程分成 5 类 lesson，便于控制节奏。
...
v4.4 课程分为 10 个模块、47 节课、9 个 Mini Project 和 1 个 Capstone。模块数量不继续扩张，优化重点放在每个模块的产物质量、前后依赖和单节课可执行性。
