...
6. 单节课写作必须可复制。47 节课都要有明确误区、代码产物、图表观察、反馈和 Checkpoint。

对当前课程最重要的优化不是增加章节，而是把 47 节课写成一条可完成的认知阶梯：
...
| [course-authoring-guide.md](./course-authoring-guide.md) | 单节课写作结构、47 节课误区矩阵、Lab 使用规则和作者自查 |
...
当前 v4.3 课程应围绕 10 个模块、47 节课、9 个 Mini Project 和 1 个 Capstone 展开。优化重点不是继续增加更多主题，而是提升每节课的学习闭环：
